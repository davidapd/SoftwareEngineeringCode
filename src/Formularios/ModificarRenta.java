 ...
 * @author HP
 */
public class ModificarRenta extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Modificar Renta");
...
JOptionPane.showMessageDialog(null, " no se obtubieron los datos correctamente");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModificarRenta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModificarRenta().setVisible(true);
            }
        });
    }
